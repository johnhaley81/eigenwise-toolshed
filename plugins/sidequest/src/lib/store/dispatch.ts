...
function prepareDispatch(slug?: any, idOrRef?: any, opts?: any) {
  ...
  try {
    ...
    const budgetRefusal = sharedTree ? null : dispatchWorktreeBudgetRefusal(projectPath, slug);
    if (budgetRefusal) throw new Error(`prepare dispatch: ${t.ref} refused: ${budgetRefusal}`);
